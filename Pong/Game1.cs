...
namespace Pong
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            PaddleBottom.X = MathHelper.Clamp(PaddleBottom.X, 0, GameConstants.ScreenWidth - PaddleBottom.Width);
            PaddleTop.X = MathHelper.Clamp(PaddleTop.X, 0, GameConstants.ScreenWidth - PaddleTop.Width);
